...
export function WorkspacePreferences() {
  ...
  const toggle = (key: 'dailyDigest' | 'dispatchAlerts') => setPreferences(current => ({ ...current, [key]: !current[key] }));
